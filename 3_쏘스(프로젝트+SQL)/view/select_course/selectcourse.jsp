...
<script type="text/javascript" src="/app/Eclog/js/cid.generate.js?vs=2fc0fa200f64659df501f62a8386baad"></script>
<script type="text/javascript">
window.CAFE24 = window.CAFE24 || {};
CAFE24.MANIFEST_CACHE_REVISION = '2203231309';
...
<td><input class="boardChk" value="15" type="checkbox" style="float: left; margin-left: 10px; margin-right: -15px;" />3</td>
                <td class="thumb"><a href="/product/detail.html"><span></span></a></td>
                <td class="displaynone"></td>
                <td class="subject">
                    <span class="displaynone">
                        <a href="#none" onclick="BOARD.viewTarget('15','5',this);"><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/board/btn_unfold.gif" alt="내용 보기"/></a>
                    </span>
                     <a href="/board/product/read.html?no=15&board_no=5" style="color:#555555;">fh</a> <img src="http://img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_new.gif"  alt="NEW" class="ec-common-rwd-image" /><img src="http://img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_attach2.gif"  alt="파일첨부" class="ec-common-rwd-image" onmouseover="BOARD.load_attached_image('afile_15','1','5');" onmouseout="BOARD.load_attached_image('afile_15','0','5');" /><span id="afile_15" style="display:none;"></span><span class="comment"></span>
                </td>
                <td>기호제학</td>
                <td class="txtLess ">2022-03-23 19:18:11</td>
                <td class="txtLess ">1</td>
                <td class="txtLess displaynone">0</td>
                <td class="displaynone"><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/board/ico_point0.gif" alt="0점"/></td>
            </tr>
<tr style="background-color:#FFFFFF; color:#555555;" class="xans-record-">
<td><input class="boardChk" value="14" type="checkbox"   style="float: left; margin-left: 10px; margin-right: -15px;"/>2</td>
                <td class="thumb"><a href="/product/detail.html"><span></span></a></td>
                <td class="displaynone"></td>
                <td class="subject">
                    <span class="displaynone">
                        <a href="#none" onclick="BOARD.viewTarget('14','5',this);"><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/board/btn_unfold.gif" alt="내용 보기"/></a>
                    </span>
                     <a href="/board/product/read.html?no=14&board_no=5" style="color:#555555;">ㅎㅇㅎㅇ</a> <span class="comment"></span>
                </td>
                <td>기호제학</td>
                <td class="txtLess ">2022-03-17 16:43:41</td>
                <td class="txtLess ">0</td>
                <td class="txtLess displaynone">0</td>
                <td class="displaynone"><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/board/ico_point0.gif" alt="0점"/></td>
            </tr>
<tr style="background-color:#FFFFFF; color:#555555;" class="xans-record-">
<td><input class="boardChk" value="13" type="checkbox" style="float: left; margin-left: 10px; margin-right: -15px;" />1</td>
                <td class="thumb"><a href="/product/detail.html"><span></span></a></td>
                <td class="displaynone"></td>
                <td class="subject">
                    <span class="displaynone">
                        <a href="#none" onclick="BOARD.viewTarget('13','5',this);"><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/board/btn_unfold.gif" alt="내용 보기"/></a>
                    </span>
                     <a href="/board/product/read.html?no=13&board_no=5" style="color:#555555;">ㅋㅋ</a> <span class="comment">[3]</span>
                </td>
                <td>기호제학</td>
                <td class="txtLess ">2022-03-17 16:43:35</td>
                <td class="txtLess ">2</td>
                <td class="txtLess displaynone">0</td>
                <td class="displaynone"><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/board/ico_point0.gif" alt="0점"/></td>
            </tr>
</tbody>
...
<form id="boardSearchForm" name="" action="/board/자유게시판/5" method="get" target="_top" enctype="multipart/form-data" >
...
<script type="text/javascript" src="/ind-script/i18n.php?lang=ko_KR&domain=front&v=2203231309" charset="utf-8"></script>
