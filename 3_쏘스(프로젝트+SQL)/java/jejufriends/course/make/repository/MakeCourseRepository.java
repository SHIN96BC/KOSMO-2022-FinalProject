...
import jejufriends.course.make.domain.CourseActivity;
import jejufriends.course.make.domain.CourseContent;
import jejufriends.course.make.domain.CourseFood;
import jejufriends.course.make.domain.CourseHotel;
import jejufriends.test.all.Activity;
import jejufriends.test.all.Food;
import jejufriends.test.all.Hotel;
import jejufriends.test.all.LandMark;
