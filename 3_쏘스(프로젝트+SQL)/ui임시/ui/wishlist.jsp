...
(function(i, s, o, g, r, a, m) {
    ...
    a.src = g;
    a.onload = function() {
        i[r].init('https://js-error-tracer-api.cafe24.com', {"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..hupRiUzE-sy-wqdUVIItQz8jNXATawhGkNatgR9ZEuo","collectWindowErrors":true,"preventDuplicateReport":true,"storageKeyPrefix":"EC_JET.MYSHOP_WISHLIST"});
    };
...
CAFE24.ROUTE = {"is_mobile":false,"is_need_route":false,"language_code":"ko_KR","path":{"origin":"\/myshop\/wish_list.html","result":"\/myshop\/wish_list.html","prefix":""},"shop_no":0,"skin_code":"default"};
</script>
...
<meta name="keywords" content="기호제학" /></head><body>
...
<td><input name="wish_idx[]" id="wish_idx_0" enable-order="1" reserve-order="N" enable-purchase="1" class="" is-set-product="F" value="3" type="checkbox"  /></td>
                <td class="thumb"><a href="/product/샘플상품-1/9/category/29/"><img src="//img.echosting.cafe24.com/thumb/img_product_medium.gif" alt=""/></a></td>
                <td class="left">
                    <strong class="name"><a href="/product/샘플상품-1/9/category/29/" class="ec-product-name">샘플상품 1</a></strong>
...
<strong class="displaynone">
                ...
                <td class="button">
                    <a href="#none" onclick="NewWishlist.actionOrder('order', 0)" class="btnSubmit ">내 일정 추가</a>
                    <a href="#none" class="btnNormal btn_wishlist_del" rel="9||000A||"><i class="icoDelete"></i> 삭제</a>
                </td>
            </tr>
            
            
	<tr class="xans-record-">
	<td><input name="wish_idx[]" id="wish_idx_1" enable-order="1" reserve-order="N" enable-purchase="1" class="" is-set-product="F" value="2" type="checkbox"  /></td>
	                <td class="thumb"><a href="/product/샘플상품-2/10/category/29/"><img src="//img.echosting.cafe24.com/thumb/img_product_medium.gif" alt=""/></a></td>
	                <td class="left">
	                    <strong class="name"><a href="/product/샘플상품-2/10/category/29/" class="ec-product-name">샘플상품 2</a></strong>
	                    <ul class="xans-element- xans-myshop xans-myshop-optionall option"><li class="xans-record-">
...
<div class="xans-element- xans-myshop xans-myshop-wishlistpaging ec-base-paginate"><a href="#none" class="first"><img src="//img.echosting.cafe24.com/skin/base/common/btn_page_first.gif" alt="첫 페이지"/></a>
...
<a href="#none"><img src="//img.echosting.cafe24.com/skin/base/common/btn_page_next.gif" alt="다음 페이지"/></a>
				...
				<fieldset class="boardSearch">
					<legend>게시물 검색</legend>
						...
						<div style="display: flex; justify-content: right; align-items: center;">
							<select id="search_key" name="search_key" fw-filter="" fw-label="" fw-msg="" style="margin-right: 2px;">
...
<!-- //결제를 위한 필수 영역 -->
		...
		var sOptionType9="";
		var sProductCode9="";
		var aProductMax9={"product_max":0,"product_max_type":"F"};
		var sItemCode9 = 'P000000I000A';
		var item_listing_type0 = 'C';
		var sOptionType10="";
		var sProductCode10="";
		var aProductMax10={"product_max":0,"product_max_type":"F"};
		var sItemCode10 = 'P000000J000A';
		var item_listing_type1 = 'C';
		var aWishlistProductData = [];
		aWishlistProductData[0] = {"wish_list_idx":3,"has_option":"F","is_soldout":"F","is_reserve_stat":"N","enable_order":true,"enable_purchase":"T","product_no":9,"product_name":"\uc0d8\ud50c\uc0c1\ud488 1","opt_id":"000A","opt_add":"","opt_add_params":"option_add[]=","opt_add_params_org":[null],"delvtype":"A","option_type":"T","main_cate_no":29,"display_group":0,"basket_type":"A0000","product_code":"P000000I","is_set_product":"F","set_product_type":"C","set_product_list":null,"item_code":"P000000I000A","add_option_name":"","add_option_name_org":"","quantity":1,"is_able_oversea":"F","basket_selected_item":"","basket_save_data":"","product_price_type":"F","option_attached_file_info_json":"","set_product_no":0,"set_product_code":null,"set_product_name":"","is_regular_delivery":false,"old_act_basket":"EC_Wishlist.PrepareBasket('9','29','','A0000','0','1','T','T','000A','P000000I000A','P000000I','');","old_act_order":"EC_Wishlist.PrepareBasket('9','29','','A0000','0','1','','T','000A','P000000I000A','P000000I','');"}
		aWishlistProductData[1] = {"wish_list_idx":2,"has_option":"F","is_soldout":"F","is_reserve_stat":"N","enable_order":true,"enable_purchase":"T","product_no":10,"product_name":"\uc0d8\ud50c\uc0c1\ud488 2","opt_id":"000A","opt_add":"","opt_add_params":"option_add[]=","opt_add_params_org":[null],"delvtype":"A","option_type":"T","main_cate_no":29,"display_group":0,"basket_type":"A0000","product_code":"P000000J","is_set_product":"F","set_product_type":"C","set_product_list":null,"item_code":"P000000J000A","add_option_name":"","add_option_name_org":"","quantity":1,"is_able_oversea":"F","basket_selected_item":"","basket_save_data":"","product_price_type":"F","option_attached_file_info_json":"","set_product_no":0,"set_product_code":null,"set_product_name":"","is_regular_delivery":false,"old_act_basket":"EC_Wishlist.PrepareBasket('10','29','','A0000','1','1','T','T','000A','P000000J000A','P000000J','');","old_act_order":"EC_Wishlist.PrepareBasket('10','29','','A0000','1','1','','T','000A','P000000J000A','P000000J','');"}
		var aWishProductSetData = [];
		var aLogData = {"log_server1":"eclog2-225.cafe24.com","log_server2":"elg-db-svcm-285.cafe24.com","mid":"rlgh2587","stype":"e","domain":"","shop_no":1,"lang":"ko_KR","ver":2,"hash":"fbb2f3a44edbd27bccae315f2604ca13","ca":"cfa-js.cafe24.com\/cfa.js","etc":""};
