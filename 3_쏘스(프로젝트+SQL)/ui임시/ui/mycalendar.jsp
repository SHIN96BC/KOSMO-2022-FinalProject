...
CAFE24.FRONT_JS_ARTICLES = {"5":{"no":5,"ucc_url":""}};
var EC_FRONT_JS_ARTICLES = CAFE24.getDeprecatedNamespace('EC_FRONT_JS_ARTICLES');
CAFE24.FRONT_JS_CONFIG_BOARD = {"iBoardNo":8,"sCommentWriterType":"N","sCommentUseId":"F"};
...
CAFE24.ROUTE = {"is_mobile":false,"is_need_route":false,"language_code":"ko_KR","path":{"origin":"\/board\/product\/read.html","result":"\/board\/product\/read.html","prefix":""},"shop_no":0,"skin_code":"default"};
</script>
...
<div id="wrap">
	...
	<div class="titleArea">
	            <h2><font color="#333333">나의 일정</font> </h2>
	            <p>나의 일정입니다.</p>
	        </div>
	</div>
					...
					<dl class="store_view">
                     ...
                     <dd>
                        ...
                        <div class="menu_box" id="menuFull">
                           <ul class="store_menu" id="storeTotMenuImg" style="display: block;"><li class="group" name="41">국수바다 상차림</li><li><span><em>육떡세트(소,2인):해물떡볶이전골(소)+육전+음료1</em></span><span class="price">39,000 원</span></li><li><span><em>(대,4인):해물떡볶이전골(대)+육전+음료1</em></span><span class="price">47,000 원</span></li><li class="group" name="42">단품메뉴</li>
                           </ul>
                        </div>
                     </dd>
                   </dl>
...
EC$(function() {
try{
var ifame_width = parent.EC$('#blog_5').parent().width();
parent.EC$('#blog_5').contents().find('body').css( 'min-width', ifame_width);
parent.EC$('#blog_5').css('width', ifame_width);
if (parseInt(parent.EC$('#blog_5').css('height')) < (document.body.scrollHeight + 70)) {
parent.EC$('#blog_5').css('height', document.body.scrollHeight + 70);
}
}catch(e){};
});
...
EC$(function(){
FwValidator.bind("form_4698497148", false);
});
