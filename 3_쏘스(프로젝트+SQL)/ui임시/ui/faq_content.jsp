...
<link rel="canonical" href="http://rlgh2587.cafe24.com/article/상품-qa/6/2/" />
...
<hr class="layout"/><div id="wrap">
	...
	<li rel="공지사항" class="xans-record-"><a href="/board/공지사항/1/" class="move">Q&A</a></li>
	<li rel="상품 Q&A" class="xans-record-"><a href="/board/상품-qa/6/" class="move">FAQ </a></li>
...
<tbody>
<tr>
<td class="board_subject" colspan="2">ascsac</td>
                </tr>
<tr>
<td class="board_sub_text" colspan="2">
						 <a href='#none' onclick=EC_BOARD_ADMIN.member_info('rlgh2587','rlgh2587');>기호제학(rlgh2587)</a> 
						 <span class="displaynone">(ip:)</span> <span id="mileage_icon"></span>
						...
						<span class="">
							작성일 2022-03-16						</span>
						<span class="displaynone">
							추천  <a href="#none" class="btnNormal" onclick="BOARD_READ.article_vote('/exec/front/Board/vote/6?no=2&return_url=%2Farticle%2F%EC%83%81%ED%92%88-qa%2F6%2F2%2F&3a2a170a628554a790914fd9a=2bd15b338770a9067814575da684ef7d&board_no=6');">추천하기</a>
						</span>
						<span class="">
							조회수 2						</span>
					</td>
...
<tr>
<td colspan="2">
                        <div class="detail"><div class="fr-view fr-view-article"><p>saccsa</p></div></div>
                    </td>
                </tr>
...
<div class="ec-base-button ">
            <span class="gLeft">
                <a href="/board/상품-qa/6/" class="btnNormalFix sizeS">목록</a>
            </span>
            <span class="gRight">
                <a href="#none" onclick="BOARD_READ.article_delete('BoardDelForm','6');" class="btnNormalFix sizeS ">삭제</a>
                <a href="/board/product/modify.html?board_act=edit&no=2&board_no=6" class="btnEmFix sizeS ">수정</a>
            </span>
        </div>
</div>
</form></div>
